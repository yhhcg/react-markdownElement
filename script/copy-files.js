...
async function copyFile(file) {
  ...
  if (ENV === 'production') {
    ...
    buildPath = path.resolve(__dirname, '../demo/node_modules/react-markdownElement/', path.basename(file));
  }
...
async function createPackageFile() {
  ...
  if (ENV === 'production') {
    ...
    buildPath = path.resolve(__dirname, '../demo/node_modules/react-markdownElement/package.json');
  }
